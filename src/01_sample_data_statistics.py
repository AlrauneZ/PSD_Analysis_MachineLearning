...
Analysis.calc_NEN5104_classification(treat_peat = True)#write_ext_data = file_data_extended)
# Analysis.filter_litho(write_ext_data = file_data_extended)
...
data = Analysis.data 
data2 = data.loc[data.litho_measured.isin(['V'])]
