...
# -*- coding: utf-8 -*-
"""
Script reproducing Figure 6 of the manuscripts containing scatter plots 
of all 6 algorithms comparing algorithm estimate of Kf to measured Kf
for the feature variables d10, d50, d60.
...
algs = ["DT", "RF", "XG", "LR", "SVR", "ANN"] # algorithms to plot (and order)
...
file_fig = '../results/Figures_paper/Fig06_Scatter_Measured_{}'.format(feature)
...
### ===========================================================================
### Create plot: load data and perform algorithm fitting to produce predictions
### ===========================================================================
